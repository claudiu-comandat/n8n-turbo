...
func CredentialTypes() []CredentialType {
	types := []CredentialType{
		...
		credential("postgres", "Postgres", text("Host", "host", "localhost"), text("Database", "database", ""), text("User", "user", ""), secret("Password", "password"), numberProp("Maximum Number of Connections", "maxConnections", 100), booleanProp("Ignore SSL Issues (Insecure)", "ignoreSSLIssues", false), selectProp("SSL", "ssl", "disable", []Option{{Name: "Disable", Value: "disable"}, {Name: "Allow", Value: "allow"}, {Name: "Prefer", Value: "prefer"}, {Name: "Require", Value: "require"}, {Name: "Verify CA", Value: "verify-ca"}, {Name: "Verify Full", Value: "verify-full"}}), numberProp("Port", "port", 5432), booleanProp("SSH Tunnel", "sshTunnel", false)),
