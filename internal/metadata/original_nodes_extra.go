					...
					"options": []any{map[string]any{
						...
						"values": []any{
							...
							map[string]any{
								...
								"type":          "number",
								"default":       1,
								"typeOptions":   map[string]any{"minValue": 1},
								"displayOptions": map[string]any{"show": map[string]any{"mode": []any{"everyX"}}},
							},
							map[string]any{
								"displayName":    "Unit",
								"name":           "unit",
								"type":           "options",
								"default":        "minutes",
								"options":        []any{map[string]any{"name": "Seconds", "value": "seconds"}, map[string]any{"name": "Minutes", "value": "minutes"}, map[string]any{"name": "Hours", "value": "hours"}, map[string]any{"name": "Days", "value": "days"}},
								"displayOptions": map[string]any{"show": map[string]any{"mode": []any{"everyX"}}},
							},
							map[string]any{
								...
								"default":        "",
								"placeholder":    "0 */5 * * * *",
								"displayOptions": map[string]any{"show": map[string]any{"mode": []any{"custom"}}},
							},
						},
					}},
				},
