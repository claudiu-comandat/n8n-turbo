import { I as h, It as ref, S as computed, q as onBeforeUnmount } from "./vue.runtime.esm-bundler-_seTmgvI.js";
...
import { Gi as sanitizeHtml, _t as useCredentialsStore, fn as useProjectsStore } from "./workflows.store-DcZL_sW6.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-UDK5E7TC.js");
			return { ConnectPopup };
		}, []);
