...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, N as defineComponent, R as inject, S as computed, T as createCommentVNode, U as mergeProps, W as nextTick, _ as Fragment, bt as withCtx, it as renderSlot, j as createVNode, jt as isRef, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-_seTmgvI.js";
import { s as useI18n$1 } from "./src-BJJttHH5.js";
import { Bi as require_markdown_it_link_attributes, gt as useRouter, ht as useRoute } from "./src-DydNw9MY.js";
...
import { A as require_uniq, Cr as CONFIGURATION_NODE_SIZE, Di as isValidNodeConnectionType, Dt as useDataSchema, Er as PUSH_NODES_OFFSET, Fi as CanvasConnectionMode, Ir as getNodesGroupSize, Kt as useTagsStore, Li as CanvasNodeRenderType, Or as doRectsOverlap, Pr as getNewNodePosition, Sr as CONFIGURABLE_NODE_SIZE, Tr as DEFAULT_VIEWPORT_BOUNDARIES, Wt as useWorkflowHelpers, X as removePreviewToken, Yt as sanitizeConnections, _ as useWorkflowExecutionStateStore, _r as mapLegacyConnectionsToCanvasConnections, _t as useCredentialsStore, ai as pinDataToExecutionData, b as injectWorkflowDocumentStore, fn as useProjectsStore, g as disposeWorkflowExecutionStateStore, gr as mapLegacyConnectionToCanvasConnection, hr as mapCanvasConnectionToLegacyConnection, j as useNodeTypesStore, k as serializeNode, kr as generateOffsets, lr as createCanvasConnectionHandleString, qt as ensureNodePosition, rn as injectNDVStore, t as useWorkflowsStore, u as getExecutionErrorToastConfiguration, v as createWorkflowDocumentId, vr as parseCanvasConnectionHandleString, wr as DEFAULT_NODE_SIZE, x as useWorkflowDocumentStore } from "./workflows.store-DcZL_sW6.js";
import { T as defineStore, t as useRootStore } from "./useRootStore-DPMB1D8p.js";
import { t as useSettingsStore } from "./settings.store-CzH-DVeq.js";
import { _ as useLocalStorage, c as useClipboard } from "./core-Dnh-TiO5.js";
import { _ as useUIStore, v as useTelemetry, x as usePostHog } from "./users.store-Cqhh8Mpv.js";
import { D as tryToParseNumber, o as getNewWorkflowData, x as isPresent } from "./workflowsList.store-CRCJaw4U.js";
import { t as useExternalHooks } from "./useExternalHooks-BCllQN1q.js";
import { t as useBuilderStore } from "./builder.store-0L3N1NxY.js";
import { c as MoveNodeCommand, d as RenameNodeCommand, f as ReplaceNodeParametersCommand, i as AddNodeCommand, l as RemoveConnectionCommand, m as useCanvasStore, n as useHistoryStore, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveNodeCommand } from "./useNodeHelpers-CyYcevDD.js";
...
import { t as core_default } from "./core-B5QF79VM.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-DPJ9OCw0.js";
import { t as VueMarkdown } from "./VueMarkdown-BIgl0KTf.js";
import { t as useSetupPanelStore } from "./setupPanel.store-CNVcfpZJ.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-D4oxroIw.js";
