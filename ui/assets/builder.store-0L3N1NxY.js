...
import { Ft as readonly, It as ref, L as hasInjectionContext, R as inject, S as computed, gt as watch } from "./vue.runtime.esm-bundler-_seTmgvI.js";
import { s as useI18n } from "./src-BJJttHH5.js";
import { Fi as isToolMessage$1, Ii as isWorkflowUpdatedMessage$1, gt as useRouter, ht as useRoute } from "./src-DydNw9MY.js";
import { t as useMessage } from "./useMessage-DXevqXy7.js";
import { t as useToast } from "./useToast-NYkrTq8y.js";
import { Fi as MODAL_CLOSE, Ii as MODAL_CONFIRM, Lu as SEVEN_DAYS_IN_MILLIS, Nu as DEBOUNCE_TIME, Pi as MODAL_CANCEL, Ri as NPS_SURVEY_MODAL_KEY, Ru as SIX_MONTHS_IN_MILLIS, Tl as getResourcePermissions, Vu as getDebounceTime, Zl as WorkflowIdKey, _c as dedupe, hc as isExpression, hu as FOCUSED_NODES_EXPERIMENT, ou as CODE_WORKFLOW_BUILDER_EXPERIMENT, sa as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, t as AutoSaveState, ui as VIEWS, yu as MERGE_ASK_BUILD_EXPERIMENT, zu as THREE_DAYS_IN_MILLIS } from "./constants-CqN-rIyX.js";
import { $t as getWorkflowVersion, Ct as getBuilderCredits, Et as useAIAssistantHelpers, Qt as getWorkflowHistory, St as getAiSessions, Tt as truncateBuilderMessages, Wt as useWorkflowHelpers, Zt as getPublishTimeline, _i as isDebouncedFunction, b as injectWorkflowDocumentStore, bt as clearBuilderSession, en as getWorkflowVersionsByIds, in as useNDVStore, pn as useSourceControlStore, t as useWorkflowsStore, tn as updateWorkflowHistoryVersion, v as createWorkflowDocumentId, x as useWorkflowDocumentStore, yt as chatWithBuilder } from "./workflows.store-DcZL_sW6.js";
import { S as STORES, T as defineStore, a as get, m as assert, s as makeRestApiRequest, t as useRootStore } from "./useRootStore-DPMB1D8p.js";
import { t as useSettingsStore } from "./settings.store-CzH-DVeq.js";
import { G as useDebounceFn, _ as useLocalStorage } from "./core-Dnh-TiO5.js";
import { _ as useUIStore, v as useTelemetry, x as usePostHog } from "./users.store-Cqhh8Mpv.js";
import { D as tryToParseNumber, T as stringSizeInBytes, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-CRCJaw4U.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-CcxmzqlN.js";
import { i as formatPlaceholderPath, r as findPlaceholderDetails } from "./src-yAR08CHK.js";
import { t as require_FileSaver_min } from "./FileSaver.min-CcOjHvdS.js";
import { m as useCanvasStore, t as useNodeHelpers } from "./useNodeHelpers-CyYcevDD.js";
