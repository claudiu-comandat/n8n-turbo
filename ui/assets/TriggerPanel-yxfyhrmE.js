...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, O as createSlots, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, n as Transition, ot as resolveDirective, p as vShow, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives, zt as shallowRef } from "./vue.runtime.esm-bundler-_seTmgvI.js";
...
import { Lt as CHAT_TRIGGER_NODE_TYPE, Na as MAX_DISPLAY_DATA_SIZE_LOGS_VIEW, cn as FORM_TRIGGER_NODE_TYPE, na as WORKFLOW_SETTINGS_MODAL_KEY, pc as NodeConnectionTypes, ui as VIEWS } from "./constants-CqN-rIyX.js";
import { Ii as CanvasNodeDirtiness, Ti as isTriggerPanelObject, Wt as useWorkflowHelpers, _ as useWorkflowExecutionStateStore, b as injectWorkflowDocumentStore, j as useNodeTypesStore, m as waitingNodeTooltip, qn as getTriggerNodeServiceName, rn as injectNDVStore, t as useWorkflowsStore } from "./workflows.store-DcZL_sW6.js";
...
import { t as CopyInput_default } from "./CopyInput-_AnfyZhu.js";
import { t as NDVEmptyState_default } from "./NDVEmptyState-Ch12eooH.js";
import { i as NodeErrorView_default, r as ViewSubExecution_default, t as RunData_default } from "./RunData-3SLPDQpz.js";
import { c as parseAiContent, o as formatTokenUsageCount } from "./useCanvasOperations-y0yiztbs.js";
import { n as useNodeType, t as usePinnedData } from "./usePinnedData-CldfRuuu.js";
import { d as require_capitalize } from "./canvas.eventBus-CG9T0dIH.js";
import { n as useExecutionRedaction, t as RedactedDataState_default } from "./RedactedDataState-_IsDHAG_.js";
...
import { r as useNodeDirtiness } from "./useRunWorkflow-SBOvM64a.js";
import { t as useInjectWorkflowId } from "./useInjectWorkflowId-Bs_RZsWt.js";
import { n as convertToDisplayDateComponents } from "./dateFormatter-CFK_hTrX.js";
import { f as getConsumedTokens, i as ConsumedTokensDetails_default, s as findLogEntryById } from "./LogsOverviewRow-BToDTH-o.js";
...
import { n as getReferencedData, t as RunDataParsedAiContent_default } from "./RunDataParsedAiContent-auZBgVj6.js";
