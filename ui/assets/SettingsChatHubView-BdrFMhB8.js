import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, j as createVNode, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-_seTmgvI.js";
...
import { Ga as VECTOR_STORE_PROVIDER_CREDENTIAL_TYPE_MAP, Ja as chatHubLLMProviderSchema, Wa as PROVIDER_CREDENTIAL_TYPE_MAP, Za as chatHubVectorStoreProviderSchema, au as CHAT_HUB_SEMANTIC_SEARCH_EXPERIMENT, vc as deepCopy } from "./constants-CqN-rIyX.js";
import { _t as useCredentialsStore } from "./workflows.store-DcZL_sW6.js";
import { D as storeToRefs, t as useRootStore } from "./useRootStore-DPMB1D8p.js";
import { t as useSettingsStore } from "./settings.store-CzH-DVeq.js";
import { _ as useUIStore, t as useUsersStore, v as useTelemetry, x as usePostHog } from "./users.store-Cqhh8Mpv.js";
...
import { g as vectorStoreProviderDisplayNames, h as providerDisplayNames, o as CHAT_PROVIDER_SETTINGS_MODAL_KEY } from "./constants-2RpVvcUH.js";
import { t as CredentialPicker_default } from "./CredentialPicker-BVkZ6mhl.js";
import { d as updateSemanticSearchSettingsApi, n as DEFAULT_SEMANTIC_SEARCH_SETTINGS, r as EMBEDDINGS_NODE_TYPE_MAP, t as useChatStore } from "./chat.store-CftxOCUz.js";
